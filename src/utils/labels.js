...
class Labels {
  static dbLog = {
    ...
    debug: (msg, meta) => logger.debug(msg, { label: "DATABASE", ...meta }),
  };
  static controllerLog = {
    ...
    debug: (msg, meta) => logger.debug(msg, { label: "CONTROLLER", ...meta }),
  };
  static authLog = {
    ...
    debug: (msg, meta) => logger.debug(msg, { label: "AUTH", ...meta }),
  };
  static serviceLog = {
    ...
    debug: (msg, meta) => logger.debug(msg, { label: "SERVICE", ...meta }),
  };
  static routeLog = {
    ...
    debug: (msg, meta) => logger.debug(msg, { label: "ROUTE", ...meta }),
  };
